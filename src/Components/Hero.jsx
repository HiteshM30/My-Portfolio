...
const Hero = ({ isDarkMode }) => {
    const [text, setText] = useState("Hitesh Matharu");
    const nameRef = useRef(null);
    const letters = "ABCDEFGHIJKLMNOPQRSTUVWXYZ";
    const originalText = "Hitesh Matharu";
                    ...
                    <div className="w-full lg:w-2/3">
                        ...
                        >
                            <div className="text-2xl lg:text-4xl font-semibold">
                                ...
                                >
                                    I'm a Data Analyst, AI Developer 
                                </motion.span>
                            </div>
                            <div className="text-lg lg:text-xl font-light">
                                ...
                                >
                                    I'm a Data Analyst and AI Developer based in India. I have a passion for uncovering insights from data and building intelligent solutions.
                                </motion.p>
                                <motion.p
                                    variants={childVariants}
                                    className={`${isDarkMode ? "text-stone-300" : "text-gray-700"} mt-2`}
                                >
                                     I love turning complex problems into actionable outcomes and creating impactful, data-driven products.
                                </motion.p>
                            </div>
                            <div className="mt-4">
                                <motion.a
