...
import { SiNumpy, SiHtml5, SiPython, SiMysql, SiScikitlearn, SiTensorflow, SiKeras } from "react-icons/si";
import { SiTableau, SiPandas, SiHuggingface } from "react-icons/si";
    ...
    return (
            <div id="technologies">
                <div id="technologies" className="mt-12 mb-12 p-5 text-center transition-all duration-500">
                    ...
                    >
                        {[ 
                            { component: SiNumpy, color: "text-green-500", duration: 2 },
                            { component: SiTableau, color: "text-blue-500", duration: 3 },
                            { component: SiPandas, color: "text-green-500", duration: 5 },
                            { component: SiHuggingface, color: "text-blue-500", duration: 3 },
                            ...
                            { component: SiScikitlearn, color: "text-gray-500", duration: 5 },
                            { component: SiTensorflow, color: "text-yellow-500", duration: 7 },
                            { component: SiKeras, color: "text-blue-500", duration: 4 }
